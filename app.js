...
(function () {
  ...
  function hero(t, lang) {
    ...
    var word = '<span style="color:var(--pear-700)">' + t.hero_title_b + '</span>' +
        '<svg viewBox="0 0 240 14" preserveAspectRatio="none" aria-hidden="true" style="position:absolute;inset-inline-start:0;bottom:' + (ar ? "-.20em" : "-.18em") + ';width:100%;height:.32em;overflow:visible"><path d="M2 9 C 60 3, 180 3, 238 8" fill="none" stroke="var(--clay-500)" stroke-width="3.5" stroke-linecap="round"/></svg>';
