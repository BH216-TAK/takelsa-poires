...
(function () {
  ...
  function hero(t, lang) {
    var ar = lang === "ar";
    var word = ar
      ? '<span style="color:var(--pear-700);background:color-mix(in srgb,var(--clay-300) 34%,transparent);border-radius:.28em;padding:.02em .2em;margin:0 -.12em">' + t.hero_title_b + '</span>'
      : '<span style="color:var(--pear-700)">' + t.hero_title_b + '</span>' +
